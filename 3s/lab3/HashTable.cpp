...
int main() {
    ...
    table.Add(std::make_pair<int,int>(0,128));
    table.Add(std::make_pair<int,int>(1,256));
    table.Add(std::make_pair<int,int>(2,-1));
    table.Add(std::make_pair<int,int>(3,0));
    table.Add(std::make_pair<int,int>(4,512));
    table.Add(std::make_pair<int,int>(5,1024));
    table.Add(std::make_pair<int,int>(6,-32));
    table.Add(std::make_pair<int,int>(7,-64));
