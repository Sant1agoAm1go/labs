...
#include <limits>
using namespace std;
const int UNINITIALIZED = -99999; // Маркер неинициализированного значения
...
private:
    string error_message_; // Сообщение об ошибке
public:
    // Конструктор с параметром - сообщением об ошибке
